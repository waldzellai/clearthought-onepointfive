...
class ArgumentationServer {
	...
	private validateArgumentData(input: unknown): ArgumentData {
		...
		const validatedData: Omit<
			ArgumentData,
			"respondsTo" | "supports" | "contradicts" | "strengths" | "weaknesses" | "suggestedNextTypes"
		> &
			Partial<
				Pick<
					ArgumentData,
			...
			nextArgumentNeeded:
				typeof data.nextArgumentNeeded === "boolean" ? data.nextArgumentNeeded : true,
		};
	...
	public processArgument(input: unknown): {
