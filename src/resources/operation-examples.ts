					...
					options: [
						{
							...
							attributes: { cost: 7, features: 10, support: 8, ease: 6 },
						},
						{
							id: "gcp",
							name: "Google Cloud Platform",
							attributes: { cost: 8, features: 9, support: 7, ease: 8 },
						},
						{
							id: "azure",
							name: "Microsoft Azure",
							attributes: { cost: 7, features: 9, support: 9, ease: 7 },
						},
					],
					criteria: [
				...
				parameters: {
					randomVariables: [
						...
						},
						{
							...
							cpt: [
								{
									when: { strategy: "aggressive", demand: "high" },
									distribution: { positive: 0.9, negative: 0.1 },
								},
								{
									when: { strategy: "aggressive", demand: "low" },
									distribution: { positive: 0.4, negative: 0.6 },
								},
								{
									when: { strategy: "cautious", demand: "high" },
									distribution: { positive: 0.7, negative: 0.3 },
								},
								{
									when: { strategy: "cautious", demand: "low" },
		...
		examples: [
			{
				...
				parameters: {
					stage: "hypothesis",
					hypothesis:
						"Remote work increases productivity by 15% due to reduced commute stress and flexible hours",
					...
					conclusion:
						"Remote work does increase individual productivity but may impact team collaboration",
				},
			},
		],
	},
		...
		examples: [
			{
				...
				parameters: {
					...
					conclusion:
						"Investing in renewable energy is both economically and environmentally imperative",
				...
				parameters: {
					personas: [
						{ id: "engineer", name: "Alex Engineer", expertise: ["technical", "scalability"] },
						{
							...
							expertise: ["branding", "customer_acquisition"],
						},
						{
							id: "designer",
							name: "Dana Designer",
							expertise: ["user_experience", "visual_design"],
						},
					],
					contributions: [
						{
							personaId: "engineer",
							content: "We need load testing before launch",
							type: "concern",
							confidence: 0.9,
						},
						{
							personaId: "marketer",
							content: "Soft launch with beta users first",
							type: "suggestion",
							confidence: 0.8,
						},
						{
							personaId: "designer",
							content: "UI needs accessibility review",
							type: "observation",
							confidence: 0.85,
						},
					],
					...
					elements: [
						{
							id: "start",
							type: "terminal",
							properties: { label: "Start", position: { x: 0, y: 0 } },
						},
						{
							id: "input",
							type: "process",
							properties: { label: "Enter credentials", position: { x: 0, y: 100 } },
						},
						{
							id: "validate",
							type: "decision",
							properties: { label: "Valid?", position: { x: 0, y: 200 } },
						},
						{
							id: "success",
							type: "terminal",
							properties: { label: "Login successful", position: { x: 100, y: 300 } },
						},
						{
							id: "error",
							type: "process",
							properties: { label: "Show error", position: { x: -100, y: 300 } },
						},
					],
				},
			},
