...
export class SocraticMethodOperation extends BaseOperation {
	...
	private generateQuestionSequence(
		...
		const generator =
			questionTypes[questionType as keyof typeof questionTypes] || questionTypes.clarification;
	...
	private generateNextQuestion(questions: any[], responses: any[]): any {
		...
		return {
			question:
				followUpTemplates[lastQuestion.type as keyof typeof followUpTemplates] ||
