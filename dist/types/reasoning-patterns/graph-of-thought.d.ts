 ...
 */
export type GraphNodeType = 'hypothesis' | 'evidence' | 'conclusion' | 'question' | 'insight' | 'assumption' | 'counterargument';
/**
 * Edge types representing relationships between nodes
 */
export type GraphEdgeType = 'supports' | 'contradicts' | 'refines' | 'questions' | 'leads-to' | 'depends-on' | 'alternatives' | 'elaborates';
/**
