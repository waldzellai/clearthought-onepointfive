...
async function startStdio() {
    try {
        ...
        const diagnosticEnabled = process.env.DIAGNOSTIC_ENABLED === "true" || process.env.CT_DIAGNOSTIC_ENABLED === "true";
        const diagnosticVerbosity = process.env.DIAGNOSTIC_VERBOSITY || process.env.CT_DIAGNOSTIC_VERBOSITY || "standard";
...
function startHttp() {
    ...
    const { app } = createStatefulServer(({ sessionId, config }) => {
