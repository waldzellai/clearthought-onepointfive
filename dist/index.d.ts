...
export default function createClearThoughtServer(options?: CreateOptions): ClearThoughtUnifiedServer | import("@modelcontextprotocol/sdk/server/index.js").Server<{
    method: string;
    params?: {
        [x: string]: unknown;
        _meta?: {
