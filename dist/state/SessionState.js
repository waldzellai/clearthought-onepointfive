...
export class SessionState {
    ...
    pdrSessions = new Map();
    /** OODA Loop Sessions */
    oodaSessions = new Map();
    /** Ulysses Protocol Sessions */
    ulyssesSessions = new Map();
    /** Metagame KPI tracking */
    metagameKPIs = new Map();
    ...
    constructor(sessionId, config) {
        ...
        this.unifiedStore = new UnifiedStore(config.persistenceEnabled
            ? {
    ...
    addArgumentation(argument) {
        this.touch();
        const isSocratic = argument.question !== undefined ||
            argument.stage !== undefined;
        if (isSocratic) {
     ...
     */
    updateActiveOperation(operation, phase, data) {
     ...
     */
    getHistoryForOperation(operation) {
