 ...
 */
export class SystemsStore extends BaseStore {
    ...
    getBySystem(systemName) {
        ...
        const partial = this.filter(system => system.system.toLowerCase().includes(systemName.toLowerCase()) &&
     ...
     */
    getSystemsWithComponent(component) {
     ...
     */
    getSystemsWithPositiveFeedback() {
        return this.filter(system => system.feedbackLoops.some(loop => loop.type === 'positive'));
    }
    /**
     * Get systems with negative feedback loops
     * @returns Array of systems with balancing loops
     */
    getSystemsWithNegativeFeedback() {
        return this.filter(system => system.feedbackLoops.some(loop => loop.type === 'negative'));
    }
    /**
     ...
     */
    getComplexityMetrics(sessionId) {
     ...
     */
    calculateAverageRelationshipStrength(system) {
     ...
     */
    calculateComplexityScore(system) {
        const factors = [
...
//# sourceMappingURL=SystemsStore.js.map