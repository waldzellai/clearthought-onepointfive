...
export class CreativeThinkingOperation extends BaseOperation {
    ...
    generateIdeas(prompt, technique) {
        ...
        switch (technique) {
            case "brainstorming":
                ideas.push("Explore alternative approaches", "Consider opposite perspectives", "Break down into smaller components");
                break;
            case "scamper":
                ideas.push("Substitute: What can be substituted?", "Combine: What can be combined?", "Adapt: What can be adapted?", "Modify: What can be modified?", "Put to other uses: How else can this be used?", "Eliminate: What can be removed?", "Reverse: What can be reversed?");
                break;
            case "random_word": {
