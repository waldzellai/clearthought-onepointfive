...
export function registerCollaborativeReasoning(server, sessionState) {
    server.tool('collaborativereasoning', 'Facilitate collaborative reasoning with multiple perspectives and personas', {
        topic: z.string(),
