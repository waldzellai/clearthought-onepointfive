            ...
            case "select": {
                ...
                if (criteria.minScore) {
                    filtered = filtered.filter((s) => {
                        const avgScore = Object.values(s.passScores).reduce((a, b) => a + b, 0) /
                ...
                if (criteria.topK) {
                    filtered = filtered
                        .sort((a, b) => {
                        const avgA = Object.values(a.passScores).reduce((sum, score) => sum + score, 0) /
                            Object.values(a.passScores).length;
                        const avgB = Object.values(b.passScores).reduce((sum, score) => sum + score, 0) /
