...
export class OrchestrationSuggestOperation extends BaseOperation {
    ...
    analyzeContext(prompt, domain, currentOperations) {
        ...
        else if (lowerPrompt.includes("decide") ||
        ...
        else if (lowerPrompt.includes("system") ||
            lowerPrompt.includes("architecture") ||
            lowerPrompt.includes("complex")) {
            problemType = "systems";
        }
        else if (lowerPrompt.includes("experiment") ||
    ...
    generateOptimizationSuggestions(pattern, contextAnalysis) {
        ...
        if (pattern.operations.some((op) => op.operation === "collaborative-reasoning") &&
